									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR> 
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer_findCustomerPage.action?pc=1"
	...
	<TR>
		<TD>
			...
			<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
				...
				<TBODY>
					<TR>
						<TD class=menuSmall><A class=style2 href='<c:url value='/linkman_addPre.action'></c:url>'
							target=main>－ 新增联系人</A></TD>
					</TR>
					<TR>
						<TD class=menuSmall><A class=style2 href="<c:url value='/linkman_list.action'></c:url>"
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall><A class=style2 href="<c:url value='/visit_addPre.action'></c:url>"
														target=main>－新增客户拜访</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="<c:url value='/visit_list.action'></c:url>"
								...
								<TR>
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="<c:url value='/customer_findAllDict.action'></c:url>"
														target=main>－ 客户信息查询</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="<c:url value='/linkman_queryPre.action'></c:url>"
														target=main>－ 联系人信息查询</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="<c:url value='/visit_queryPre.action'></c:url>"
								...
								<TR>
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="<c:url value='customer_countByLevel.action'></c:url>"
														target=main>－客户行业统计</A></TD>
												</TR>
												
												<TR>
													<TD class=menuSmall><A class=style2 href="customer_countBySource.action"
